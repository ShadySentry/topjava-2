...
public class MealTestData {
    ...
    public static final Meal MEAL_TEST = new Meal(MEAL1_ID + 100, of(2018, Month.MAY, 31, 20, 0), "Ужин", 999);
    ...
    public static Meal getCreated() {
        return new Meal( of(2015, Month.JUNE, 1, 18, 0), "Созданный ужин", 300);
    }
